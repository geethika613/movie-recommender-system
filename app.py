...
st.set_page_config(page_title="MOVIE BUFF",layout="wide")
...
st.markdown('<p class="big-font">Crackle</p>', unsafe_allow_html=True)
...
def set_bg():
      st.markdown(
        f"""
         <style>
         .stApp {{
             background: url("https://cdn.dribbble.com/users/2522172/screenshots/14777334/media/07b4f226c700d5557be52e4a449d3e3c.png?compress=1&resize=768x576&vertical=top")}}
         </style>
         """,
        unsafe_allow_html=True
    )
